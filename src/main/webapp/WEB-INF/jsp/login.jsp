    ...
    <div class="warp">
        ...
        <div class="up"style="background:url(..//img//login_background.png)">
            ...
            <div id="div_login">
               ...
               <div class="mid">
               <input type="checkbox" class="box" style="float:left ;margin-top:0"></input>&nbsp;&nbsp;&nbsp;&nbsp;<p id="mid-left">   记住密码</p>
               <a  href="#">忘记密码？</a>
                ...
                <button type="button" class="b-left"> 登 录</button>
                </div>
                <div class="button-right">
                <button type="button" class="b-right"> 注 册 </button>
                </div>
                </div>
            </div>
        ...
        <div class="down">
            ...
            <p id="p-word" style="color:#415A8F">合作网站</p>
              <img src="../img/公司1.jpg"   style="width:200px; height:95px; display:inline-block;padding-right:20px;border-right:medium solid #BCAE92">
            ...
            <div id="div_leaf">
             ...
             <div id="l-p"><img src="../img/微信.jpg"><p>微 信</p></div>
             <div id="l-p" style="margin-right:30px"><img src="../img/微博.jpg"><p>微 博</p></div>
            </div>
            <footer>
        </div>
